...
/// List of emojis in English.
///
/// Imported from the [emoji_picker_flutter](https://github.com/Fintasys/emoji_picker_flutter/blob/master/lib/locales/emoji_set_en.dart) Flutter plugin.
const List<Emoji> emojiList = [
  // Smileys
  Emoji(
    '😀',
